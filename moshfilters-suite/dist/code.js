...
function start() {
  var sandboxApi = {
    createImage: function () {
      var _createImage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(blob) {
        var size,
          insertionParent,
          bitmapImage,
          _args = arguments;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              size = _args.length > 1 && _args[1] !== undefined ? _args[1] : {};
              console.log("entered createImage function");
              insertionParent = express_document_sdk__WEBPACK_IMPORTED_MODULE_1__.editor.context.insertionParent;
              _context.next = 5;
              return express_document_sdk__WEBPACK_IMPORTED_MODULE_1__.editor.loadBitmapImage(blob);
            case 5:
              bitmapImage = _context.sent;
              _context.next = 8;
              return express_document_sdk__WEBPACK_IMPORTED_MODULE_1__.editor.queueAsyncEdit(function () {
                ...
                var mediaContainerNode = express_document_sdk__WEBPACK_IMPORTED_MODULE_1__.editor.createImageContainer(bitmapImage, {
                  initialSize: {
                    width: width,
                    height: height
                  }
            ...
            case 8:
              return _context.abrupt("return", "**** Image created successfully ****");
            case 9:
            case "end":
